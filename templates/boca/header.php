		...
		<div class="contentpopup">
			...
			<header><div class="icon"></div>
				...
				<div id="search">
						...
						<div class="right"><form id="searchform" method="post"><input type="text" name="search_query" id="search_query" /><input type="text" name="search_query2" id="search_query2" /></form></div>
					</div>
			</header>
