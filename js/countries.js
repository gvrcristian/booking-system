...
// Rooms type
var room_arr = new Array("1 Room", "2 Rooms", "3 Rooms", "4 Rooms", "Penthouse");
var room_arr2 = new Array("1r", "2r", "3r", "4r", "penth");
...
function populateRoom(roomElementId)
{
	
	var roomElement = document.getElementById(roomElementId);
	roomElement.length=0;
	roomElement.options[0] = new Option('Type of room','-1');
	roomElement.selectedIndex = 0;
	for (var i=0; i<room_arr.length; i++)
	{
		roomElement.options[roomElement.length] = new Option(room_arr[i],room_arr2[i]);
	}
}